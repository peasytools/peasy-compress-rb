...
Compression library for Ruby — gzip, deflate, and zlib compression with ratio calculation. Uses Ruby stdlib Zlib, zero external dependencies.
...
# Check version
puts PeasyCompress::VERSION  # => "0.1.1"
```
...
| **crates.io** | [peasy-compress](https://crates.io/crates/peasy-compress) | `cargo add peasy-compress` |
...
|---------|------|-----|----------|-----------|-------------|
| **peasy-compress** | [PyPI](https://pypi.org/project/peasy-compress/) | [npm](https://www.npmjs.com/package/peasy-compress) | **[Gem](https://rubygems.org/gems/peasy-compress)** | [Crate](https://crates.io/crates/peasy-compress) | **Compression — gzip, deflate, brotli** |
